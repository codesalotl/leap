...
class ChartOfAccountSeeder extends Seeder
{
    public function run(): void
    {
        $accounts = [
            // TRAVELING EXPENSES
            [
                'account_code' => '5-02-01-010',
                'account_title' => 'Traveling Expenses - Local',
                'expense_class' => 'MOOE',
            ],
            [
                'account_code' => '5-02-01-020',
            ...
            // UTILITY EXPENSES
            [
                'account_code' => '5-02-05-010',
                'account_title' => 'Water Expenses',
                'expense_class' => 'MOOE',
            ],
            [
                'account_code' => '5-02-05-020',
            ...
            [
                'account_code' => '5-02-05-030',
                'account_title' => 'Postage and Courier Services',
                'expense_class' => 'MOOE',
            ],
            [
                'account_code' => '5-02-05-040',
                'account_title' => 'Telephone Expenses',
                'expense_class' => 'MOOE',
            ],
            [
                'account_code' => '5-02-05-030-01',
            ...
            [
                'account_code' => '5-02-11-010',
                'account_title' => 'Legal Services',
                'expense_class' => 'MOOE',
            ],
            [
                'account_code' => '5-02-11-030',
            ...
            // GENERAL SERVICES
            [
                'account_code' => '5-02-12-020',
                'account_title' => 'Janitorial Services',
                'expense_class' => 'MOOE',
            ],
            [
                'account_code' => '5-02-12-030',
        ...
        foreach ($accounts as $account) {
            DB::table('chart_of_accounts')->updateOrInsert(
                ['account_code' => $account['account_code']], // Unique check
                [
