...
function CommandItem({
  ...
  return (
    ...
    >
      {children}
      <CheckIcon className="mt-0.5 ml-auto opacity-0 group-has-data-[slot=command-shortcut]/command-item:hidden group-data-[checked=true]/command-item:opacity-100" />
    </CommandPrimitive.Item>
  )
}
