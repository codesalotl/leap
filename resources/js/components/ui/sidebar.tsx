...
const SIDEBAR_WIDTH_ICON = "2.875rem" // change this to change the width of sidebar
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "bg-background md:peer-data-[variant=inset]:m-0 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-none md:peer-data-[variant=inset]:shadow-none md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-0 relative flex w-full flex-1 flex-col",
        className
      )}
      {...props}
    />
